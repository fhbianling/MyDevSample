 ...
 * desc ${PopupWindow基类}
 */
public abstract class AbsBasePopupWindow extends PopupWindow {
    ...
    public AbsBasePopupWindow(Activity mContext) {
        this(mContext, true, false);
    }

    public AbsBasePopupWindow(Activity mContext, boolean inflateImmediately) {
        this(mContext, inflateImmediately, true);
    }

    private AbsBasePopupWindow(Activity mContext, boolean inflateImmediately, boolean shouldBackAlpha) {
     ...
     */
    public AbsBasePopupWindow(Activity mContext, boolean inflateImmediately, boolean shouldBackAlpha, boolean shouldMatchHeight) {
        super(mContext);
